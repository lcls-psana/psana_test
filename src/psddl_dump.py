...
def Andor_ConfigV2_to_str(obj, indent, lvl, methodSep):
    assert obj.TypeId == psana.Andor.ConfigV2.TypeId
    assert obj.Version == psana.Andor.ConfigV2.Version
    methodStrings = []
    # one_line_methods
    methodStr = doIndent(indent, lvl)
    methodStr += 'width: %s' % uint32_to_str( obj.width() )
    ...
    methodStr = doIndent(indent, lvl)
    methodStr += 'cropMode:\n'
    methodStr += enum_to_str(obj.cropMode(), indent, lvl+1, methodSep)
    methodStrings.append(methodStr)
    methodStrings = [meth for meth in methodStrings if len(meth)>0]
    return methodSep.join(methodStrings)
...
def Epix_Config10kaV2_to_str(obj, indent, lvl, methodSep):
    assert obj.TypeId == psana.Epix.Config10kaV2.TypeId
    assert obj.Version == psana.Epix.Config10kaV2.Version
    methodStrings = []
    # one_line_methods
    methodStr = doIndent(indent, lvl)
    methodStr += 'version: %s' % uint32_to_str( obj.version() )
    ...
    methodStrings.append(methodStr)                                 
    methodStr = doIndent(indent, lvl)
    methodStr += 'epixDaqTrigDelay: %s' % uint32_to_str( obj.epixDaqTrigDelay() )
    methodStrings.append(methodStr)                                 
    methodStr = doIndent(indent, lvl)
    methodStr += 'dacSetting: %s' % uint32_to_str( obj.dacSetting() )
    methodStrings.append(methodStr)                                 
    ...
    methodStrings.append(methodStr)                                 
    methodStr = doIndent(indent, lvl)
    methodStr += 'ghostCorrEn: %s' % uint32_to_str( obj.ghostCorrEn() )
    methodStrings.append(methodStr)                                 
    methodStr = doIndent(indent, lvl)
    methodStr += 'oversampleEn: %s' % uint32_to_str( obj.oversampleEn() )
    methodStrings.append(methodStr)                                 
    methodStr = doIndent(indent, lvl)
    methodStr += 'oversampleSize: %s' % uint32_to_str( obj.oversampleSize() )
    methodStrings.append(methodStr)                                 
    methodStr = doIndent(indent, lvl)
    methodStr += 'firmwareHash: %s' % str_to_str( obj.firmwareHash() )
    methodStrings.append(methodStr)                                 
    methodStr = doIndent(indent, lvl)
    methodStr += 'firmwareDesc: %s' % str_to_str( obj.firmwareDesc() )
    methodStrings.append(methodStr)                                 
    methodStr = doIndent(indent, lvl)
    methodStr += 'asicPixelConfigArray: %s' % ndarray_to_str( obj.asicPixelConfigArray() )
    methodStrings.append(methodStr)                                 
...
def Epix_Elem10kaConfigV1_to_str(obj, indent, lvl, methodSep):
    methodStrings = []
    # one_line_methods
    methodStr = doIndent(indent, lvl)
    methodStr += 'carrierId0: %s' % uint32_to_str( obj.carrierId0() )
...
def Epix_Quad10kaConfigV1_to_str(obj, indent, lvl, methodSep):
    methodStrings = []
    # one_line_methods
    methodStr = doIndent(indent, lvl)
    methodStr += 'baseClockFrequency: %s' % uint32_to_str( obj.baseClockFrequency() )
...
def Epix_Quad10kaConfigV2_to_str(obj, indent, lvl, methodSep):
    methodStrings = []
    # one_line_methods
    methodStr = doIndent(indent, lvl)
    methodStr += 'baseClockFrequency: %s' % uint32_to_str( obj.baseClockFrequency() )
    ...
    methodStrings.append(methodStr)                                 
    methodStr = doIndent(indent, lvl)
    methodStr += 'dummyAcqEn: %s' % uint32_to_str( obj.dummyAcqEn() )
    methodStrings.append(methodStr)                                 
    methodStr = doIndent(indent, lvl)
    methodStr += 'asicSyncInjEn: %s' % uint32_to_str( obj.asicSyncInjEn() )
    methodStrings.append(methodStr)                                 
    methodStr = doIndent(indent, lvl)
    methodStr += 'asicSyncInjDly: %s' % uint32_to_str( obj.asicSyncInjDly() )
    methodStrings.append(methodStr)                                 
    methodStr = doIndent(indent, lvl)
    methodStr += 'adcPipelineDelay: %s' % uint32_to_str( obj.adcPipelineDelay() )
    methodStrings.append(methodStr)                                 
...
def Epix_Config10kaQuadV1_to_str(obj, indent, lvl, methodSep):
    ...
    methodStr = doIndent(indent, lvl)
    methodStr += 'quad:\n'
    methodStr += Epix_Quad10kaConfigV1_to_str(obj.quad(), indent, lvl+1, methodSep)
    methodStrings.append(methodStr)
    # idx_list_multi_line_methods
    methodStr = ''
    numObjs = 4
    for idx in range( numObjs ):
        ...
        methodStr += doIndent(indent, lvl)
        methodStr += 'elemCfg[%d]:\n' % idx
        methodStr += Epix_Elem10kaConfigV1_to_str(subObj, indent, lvl+1, methodSep)
        if idx+1 < numObjs:
            methodStr += '\n'
    methodStrings.append(methodStr)
    methodStrings = [meth for meth in methodStrings if len(meth)>0]
...
def Epix_Config10kaQuadV2_to_str(obj, indent, lvl, methodSep):
    assert obj.TypeId == psana.Epix.Config10kaQuadV2.TypeId
    assert obj.Version == psana.Epix.Config10kaQuadV2.Version
    methodStrings = []
    # one_line_methods
    methodStr = doIndent(indent, lvl)
    methodStr += 'numberOfElements: %s' % uint32_to_str( obj.numberOfElements() )
    ...
    methodStr = doIndent(indent, lvl)
    methodStr += 'quad:\n'
    methodStr += Epix_Quad10kaConfigV2_to_str(obj.quad(), indent, lvl+1, methodSep)
    methodStrings.append(methodStr)
    # idx_list_multi_line_methods
    methodStr = ''
    numObjs = 4
...
def Epix_Config10ka2MV1_to_str(obj, indent, lvl, methodSep):
    ...
    for idx in range( numObjs ):
        ...
        methodStr += doIndent(indent, lvl)
        methodStr += 'quad[%d]:\n' % idx
        methodStr += Epix_Quad10kaConfigV1_to_str(subObj, indent, lvl+1, methodSep)
        if idx+1 < numObjs:
            methodStr += '\n'
    methodStrings.append(methodStr)
    methodStr = ''
...
def Epix_Config10ka2MV2_to_str(obj, indent, lvl, methodSep):
    assert obj.TypeId == psana.Epix.Config10ka2MV2.TypeId
    assert obj.Version == psana.Epix.Config10ka2MV2.Version
    methodStrings = []
    # one_line_methods
    methodStr = doIndent(indent, lvl)
    methodStr += 'numberOfElements: %s' % uint32_to_str( obj.numberOfElements() )
    ...
    for idx in range( numObjs ):
        ...
        methodStr += doIndent(indent, lvl)
        methodStr += 'quad[%d]:\n' % idx
        methodStr += Epix_Quad10kaConfigV2_to_str(subObj, indent, lvl+1, methodSep)
        if idx+1 < numObjs:
            methodStr += '\n'
    methodStrings.append(methodStr)
    methodStr = ''
...
def Bld_BldDataBeamMonitorV1_to_str(obj, indent, lvl, methodSep):
    ...
    methodStrings.append(methodStr)                                 
    methodStr = doIndent(indent, lvl)
    methodStr += 'peakA: %s' % ndarray_to_str( obj.peakA() )
    methodStrings.append(methodStr)                                 
    methodStr = doIndent(indent, lvl)
    methodStr += 'peakT: %s' % ndarray_to_str( obj.peakT() )
    methodStrings.append(methodStr)                                 
    methodStrings = [meth for meth in methodStrings if len(meth)>0]
    return methodSep.join(methodStrings)
...
objFunctionTable = {
    ...
    (psana.Andor.ConfigV2.TypeId,2) : Andor_ConfigV2_to_str,
    ...
    (psana.Epix.Config10ka2MV2.TypeId,2) : Epix_Config10ka2MV2_to_str,
    (psana.Epix.Config10kaQuadV1.TypeId,1) : Epix_Config10kaQuadV1_to_str,
    (psana.Epix.Config10kaQuadV2.TypeId,2) : Epix_Config10kaQuadV2_to_str,
    (psana.Epix.Config10kaV1.TypeId,1) : Epix_Config10kaV1_to_str,
    (psana.Epix.Config10kaV2.TypeId,2) : Epix_Config10kaV2_to_str,
